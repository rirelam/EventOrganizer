...
namespace EventOrganizer.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("EventOrganizer") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "EventOrganizer", DisplayName = "EventOrganizer API", Resources = { "EventOrganizer" }
            });
        }
    }
