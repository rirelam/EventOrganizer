...
public class MongoDbEventOrganizerDbSchemaMigrator : IEventOrganizerDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbEventOrganizerDbSchemaMigrator(IServiceProvider serviceProvider)
    {
